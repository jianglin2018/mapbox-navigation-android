...
class MapRouteLine {
  ...
  MapRouteLine(Context context,
    ...
    routeLineCap = buildLineCapFrom(typedArray);
  ...
  private String buildLineCapFrom(TypedArray typedArray) {
    String lineCap = typedArray.getString(R.styleable.NavigationMapRoute_routeLineCap);
  ...
  private void initializeLayers(MapboxMap mapboxMap, MapRouteLayerProvider layerProvider) {
    ...
    LineLayer routeLayer = layerProvider.initializeRouteLayer(
      mapboxMap, routeLineCap, routeScale, alternativeRouteScale,
